        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-sm font-medium text-gray-950 dark:text-white">
                    {{ __('mipress::admin.curator_media.focal_point_editor.label') }} <span x-text="`${x}% / ${y}%`" class="text-primary-600 dark:text-primary-400"></span>
                </p>
                <button
                    type="button"
                ...
                >
                    ...
                    {{ __('mipress::admin.curator_media.focal_point_editor.open_editor') }}
                </button>
            </div>
        </div>
                ...
                <div class="flex h-full flex-col overflow-hidden bg-white dark:bg-gray-900">
                    ...
                    <div class="flex shrink-0 items-center justify-between border-b border-gray-200 px-6 py-3 dark:border-white/10">
                        <div class="flex items-center gap-3">
                            <h2 class="text-base font-semibold text-gray-950 dark:text-white">{{ __('mipress::admin.curator_media.focal_point_editor.modal_title') }}</h2>
                        ...
                        <div class="flex items-center gap-2">
                            <button
                                ...
                                x-on:click="reset()"
                            >
                                {{ __('mipress::admin.curator_media.focal_point_editor.reset') }}
                            </button>
                            <button
                                type="button"
                            ...
                            >
                                {{ __('mipress::admin.curator_media.focal_point_editor.done') }}
                            </button>
                            <button
                                type="button"
                                ...
                                x-on:click="closeModal()"
                                title="{{ __('mipress::admin.curator_media.focal_point_editor.close') }}"
                            >
                        ...
                        <div class="flex w-1/2 flex-col gap-4 overflow-y-auto border-r border-gray-200 p-6 dark:border-white/10">
                            <div>
                                <p class="text-xs leading-5 text-gray-500 dark:text-gray-400">
                                    {{ __('mipress::admin.curator_media.focal_point_editor.instruction') }}
                                </p>
                            </div>
                            ...
                            <p class="rounded-xl bg-gray-50 px-3 py-2 text-xs leading-5 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                                {{ __('mipress::admin.curator_media.focal_point_editor.hint') }}
                            </p>
                        </div>

                        {{-- Right: Live aspect ratio previews --}}
                        <div class="flex w-1/2 flex-col overflow-y-auto p-6">
                            <h3 class="mb-4 text-sm font-semibold text-gray-950 dark:text-white">{{ __('mipress::admin.curator_media.focal_point_editor.live_previews') }}</h3>
...
@else
    <div class="py-4 text-center text-sm text-gray-500 dark:text-gray-400">
        {{ __('mipress::admin.curator_media.focal_point_editor.image_only') }}
    </div>
@endif
